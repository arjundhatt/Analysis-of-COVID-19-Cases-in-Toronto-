...
Below is a histogram created from the fatal-filtered dataset to see the distribution of age groups in the fatal cases of COVID-19: 
...
ggplot(data=fataldata, aes(ageoffatal)) + 
  geom_histogram(stat="count") +scale_x_discrete(labels = c('<=19','20 to 29','30 to 39','40 to 49', '50 to 59', '60 to 69', '70 to 79','80 to 89','90+', 'Unknown')) + ggtitle("Age Group of Fatal COVID-19 Cases") + xlab("Age Group") + ylab("Cases")
```
...
ggplot(data=fataldata, aes(ageoffatal)) + 
  ...
  scale_x_discrete(labels = c('<=19',
                              ...
                              '80 to 89','90+',
                              'Unknown')) + 
  ggtitle("Age Group of Fatal COVID-19 Cases") + 
  xlab("Age Group") + ylab("Cases")
```

Code and data supporting this analysis is available in the following Github repo: https://github.com/arjundhatt/Analysis-of-COVID-19-Cases-in-Toronto-

Under: Analysis-of-COVID-19-Cases-in-Toronto- -> content -> post ->2015-07-23-r-rmarkdown.Rmd
